...
func main() {
	...
	/*
		NewWithDefaultRegistry is important.
	...
	*/
	...
	prometheusMiddleware :=
		fiberprometheus.NewWithDefaultRegistry("devops-training-backend")
...
func connectDatabase() {
	...
	if databaseURL == "" {
		...
		dbName := getEnv("DB_NAME", "devops_training")
	...
	if err != nil {
		log.Fatal("Unable to create PostgreSQL connection pool:", err)
	}
...
func getTasks(c *fiber.Ctx) error {
	...
	if err := rows.Err(); err != nil {
		log.Println("Error iterating tasks:", err)
